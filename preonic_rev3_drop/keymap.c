 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ____ | ____ |  Up  | ____ | ____ | ____ | ____ | ____ |Num 7 |Num 8 |Num 9 |Num + |
 * |------+------+------+------+------+------+------+------+--- --+--- --+--- --+--- --|
 * | _TT_ | Left | Down |Right | ____ | ____ | ____ | ____ |Num 4 |Num 5 |Num 6 |   ,  |
 * |------+------+------+------+------+------+------+------+--- --+--- --+--- --+--- --|
...
[_NUMPAD] = LAYOUT_preonic_1x2uC(
    ...
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_COMM,
