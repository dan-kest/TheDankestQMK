...
/* Mouse
 * ,-----------------------------------------------------------------------------------.
 * |  Esc |MAcc1 |MAcc2 |MAcc3 |      |      |      |      |PrtSc |ScrLk |Pause | ____ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ____ |      | M Up |      |      |      |      |MBtn3 |MBtn3 | Home | PgUp | Stop |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |_WHEL |MLeft |MDown |MRght |      |      |      |MBtn1 |MBtn2 |  End | PgDn | ____ |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | ____ |      |      |      |      |      |      |MBtn4 |MBtn5 | Play | Prev | Next |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ____ | ____ | ____ | ____ |      |     ____    |      | ____ | Mute | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_MOUSE] = LAYOUT_preonic_1x2uC(
    KC_ESC,  KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, KC_SLCK, KC_PAUS, _______,
    _______, XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN3, KC_BTN3, KC_HOME, KC_PGUP, KC_MSTP,
    MO_WHEL, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, KC_BTN2, KC_END,  KC_PGDN, _______,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN4, KC_BTN5, KC_MPLY, KC_MPRV, KC_MNXT,
    _______, _______, _______, _______, XXXXXXX,      _______,     XXXXXXX, _______, KC_MUTE, KC_VOLD, KC_VOLU
),

/* Mouse Wheel
 * ,-----------------------------------------------------------------------------------.
 * |  Esc |MAcc1 |MAcc2 |MAcc3 |      |      |      |      |PrtSc |ScrLk |Pause | Back |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Tab |      | MWUp |      |      |      |      |MBtn3 |MBtn3 | Home | PgUp | Stop |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | ____ |MWLft |MWDwn |MWRgt |      |      |      |MBtn1 |MBtn2 |  End | PgDn |Enter |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |Shift |      |      |      |      |      |      |MBtn4 |MBtn5 | Play | Prev | Next |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |  Del |  Alt |      |     ____    |      | ____ | Mute | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_WHEEL] = LAYOUT_preonic_1x2uC(
    ...
    _______, KC_WH_L, KC_WH_D, KC_WH_R, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,      _______,     _______, _______, _______, _______, _______
),
